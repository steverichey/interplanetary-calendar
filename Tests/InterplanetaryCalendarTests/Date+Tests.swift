...
class DateTests: XCTestCase {
    func testTimeSince() {
        ...
        XCTAssertEqual(2458239.67425, date.daysSince(epoch: .julian, timeStandard: .coordinatedUniversal), percentAccuracy: 0.00001)
        XCTAssertEqual(2458239.67506, date.daysSince(epoch: .julian, timeStandard: .terrestrial), percentAccuracy: 0.00001)
        XCTAssertEqual(6694.67506, date.daysSince(epoch: .j2000, timeStandard: .terrestrial), percentAccuracy: 0.00001)
